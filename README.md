...
The source code here (a mix of Python and SQL) includes a main function to demonstrate the functionality of this program. I have added comments to describe the functions when they are declared and when they are being called. I am using the command 'python elibrary.py' to run the code.
